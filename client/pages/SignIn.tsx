...
export default function SignIn() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (error) {
      ...
      const hasSelectedRole = localStorage.getItem("tradego_role_selected");
      if (!hasSelectedRole) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-violet-600/[0.04] rounded-full blur-[80px]" />
      </div>
