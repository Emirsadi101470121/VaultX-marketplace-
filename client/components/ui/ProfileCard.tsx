      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="w-full absolute left-1/2 will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <img
                        ...
                        loading="lazy"
                        style={{ display: 'block', gridArea: 'auto', borderRadius: '50%', pointerEvents: 'auto', objectPosition: 'top' }}
                        onError={e => {
                          const t = e.target as HTMLImageElement;
                          t.style.opacity = '0.5';
                          t.src = avatarUrl;
